...
local updateTriggered = false -- Флаг, чтобы не запускать обновление дважды
...
function checkScriptUpdate()
    ...
    queueHttpRequest(SCRIPT_VER_URL .. "?t=" .. os.time(), function(remoteVer)
        ...
        if cleanRemoteVer and cleanRemoteVer ~= currentVer and not updateTriggered then
            ...
            sampAddChatMessage(u8:decode("{0633E5}[AH] {FFFFFF}Найдена новая версия {00FF00}v" .. cleanRemoteVer .. "{FFFFFF}. Обновляюсь..."), -1)
